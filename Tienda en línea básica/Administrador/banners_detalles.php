...
echo "<html>
		...
		<table border=\"1\" class = \"table2\" width=\"960\">
			...
			<a href=\"banners_listado.php\"><input id=\"campo1\" type=\"button\" name=\"RegresoLista\" class = \"back\" value=\"Regresar al listado\"></a>
			<table border = \"1\" colspan = \"1\" width = \"400\" class = \"table\">
				<tr> 
					<td class = \"rows\">Nombre del banner:</td>
				</tr>
				<tr> 
			...
			echo "<tr> 
				...
				echo "<tr><td class = \"rows\">Imagen del Banner:</td></tr>
					<tr>
						<td><img width=\"374\" src = \"Banners/$archivo\"/></td>
					</tr>
			</table>
		</body>
	</html>";
